import sys
from PyQt6.QtWidgets import QApplication, QWidget, QLineEdit, QRadioButton, QPushButton
...
class Window(QWidget):
    ...
    def getValues(self):
        ...
        if self.male.isChecked():
            print(f"{name} {surname} You are a male")
        else:
            print(f"{name} {surname} You are a female")
